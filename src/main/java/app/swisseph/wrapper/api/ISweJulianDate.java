...
package app.swisseph.wrapper.api;


import app.swisseph.wrapper.app.SweRuntimeException;
import app.swisseph.core.SweConst;
import java.io.Serializable;

import static java.lang.Double.isNaN;
import static app.swisseph.wrapper.api.ISweConstants.*;
 ...
 * <br><br>
 * The class instance should be created or initialized by corresponding {@link app.swisseph.wrapper.ISwissEph} methods.
 * <br><br>
 * Proper initialization by corresponding {@link app.swisseph.wrapper.ISwissEph} methods for an instance of
 * {@link ISweJulianDate} with incomplete or mix of Local and UTC datetime is not guaranteed!!!
 * <br><br>
 * see creation/initialization of {@link app.swisseph.core.SweDate} as a reference!
 *
 * @author Yura Krymlov
 * @version 1.2, 2023-03
 */
