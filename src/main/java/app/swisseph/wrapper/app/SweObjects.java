...
import app.swisseph.wrapper.api.ISweGeoLocation;
import app.swisseph.wrapper.api.ISweJulianDate;
import app.swisseph.wrapper.api.ISweObjects;
import app.swisseph.wrapper.api.ISweObjectsOptions;

import java.util.Arrays;

import static java.lang.Double.isNaN;
import static app.swisseph.wrapper.api.ISweConstants.*;
import static app.swisseph.wrapper.api.ISweJulianDate.IDXD_DELTAT;
import static app.swisseph.wrapper.api.ISweJulianDate.IDXD_ETIME;
import static app.swisseph.core.SweConst.*;
