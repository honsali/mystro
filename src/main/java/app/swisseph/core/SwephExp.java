...
/**
 * This class represents the standard application interface (API) to the Swiss
 * Ephemeris.
 * <p>
 * The function calls are documented in the Programmer's documentation, which is
 * online in HTML format
 * <p>
 * exported functions:
 * <a href="https://www.astro.com/ftp/swisseph/src/swephexp.h">...</a>
 *
 * @author Yura Krymlov
 * @version 2.10
 */
public class SwephExp {
        ...
        public static native int swe_heliacal_angle(double tjdut, double[] dgeo, double[] datm, double[] dobs,
                        int helflag, double mag, double azi_obj, double azi_sun, double azi_moon, double alt_moon,
                        double[] dret, StringBuilder serr);

        public static native int swe_topo_arcus_visionis(double tjdut, double[] dgeo, double[] datm, double[] dobs,
                        int helflag, double mag, double azi_obj, double alt_obj, double azi_sun, double azi_moon,
                        double alt_moon, double[] dret, StringBuilder serr);
        ...
        public static native int swe_gauquelin_sector(double t_ut, int ipl, StringBuilder starname, int iflag,
                        int imeth, double[] geopos, double atpress, double attemp, double[] dgsect, StringBuilder serr);
        ...
        public static native int swe_lun_occult_where(double tjd, int ipl, StringBuilder starname, int ifl,
        ...
        public static native int swe_sol_eclipse_when_loc(double tjd_start, int ifl, double[] geopos, double[] tret,
        ...
        public static native int swe_lun_occult_when_glob(double tjd_start, int ipl, StringBuilder starname, int ifl,
                        int ifltype,
                        double[] tret, int backward, StringBuilder serr);
        ...
        public static native double swe_refrac_extended(double inalt, double geoalt, double atpress, double attemp,
                        double lapse_rate, int calc_flag, double[] dret);
        ...
        public static native int swe_orbit_max_min_true_distance(double tjd_et, int ipl, int iflag, double[] dmax,
        ...
        public static native void swe_split_deg(double ddeg, int roundflag, int[] iDegMinSec, double[] dsecfr,
                        int[] isgn);
        ...
        public static native int swe_helio_cross(int ipl, double x2cross, double jd_et, int iflag, int dir,
                        double[] jd_cross, StringBuilder serr);

        public static native int swe_helio_cross_ut(int ipl, double x2cross, double jd_ut, int iflag, int dir,
                        double[] jd_cross, StringBuilder serr);
