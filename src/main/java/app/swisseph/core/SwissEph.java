...
import app.swisseph.wrapper.app.SweJulianDate;
import app.swisseph.core.SweDate.IDate;
...
import static app.swisseph.wrapper.api.ISweJulianDate.UT_TMZ;
import static app.swisseph.core.SweConst.SE_GREG_CAL;
...
if (false) {
  ...
  * @see app.swisseph.core.SwissEph#getFixstarMagnitude(StringBuilder)
  */
  ...
  * @return     magnitude of the star.
  * @see app.swisseph.core.SwissEph#getFixstarMagnitude(String)
  */
