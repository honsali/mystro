...
public abstract class TransitCalculator {
  ...
  */
   ...
   * (=UT&nbsp;+&nbsp;deltaT).<p>
   * See app.swisseph.core.TCPlanet or app.swisseph.core.TCPlanetPlanet below for examples on
   ...
   * @see app.swisseph.core.TCPlanet
   * @see app.swisseph.core.TCPlanetPlanet
   */
