package app.swisseph.core;

import app.swisseph.wrapper.ISwissEph;
...
//  * SweConst.SE_HSYS_GAUQUELIN_SECTORS<BR>
  ...
  * @see app.swisseph.core.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double)
  * @see app.swisseph.core.TCPlanet#TCPlanet(SwissEph, int, int, double)
  * @see app.swisseph.core.SweConst#SEFLG_TRANSIT_LONGITUDE
  * @see app.swisseph.core.SweConst#SEFLG_SIDEREAL
  * @see app.swisseph.core.SweConst#SE_HOUSE1
  * @see app.swisseph.core.SweConst#SE_HOUSE2
  * @see app.swisseph.core.SweConst#SE_HOUSE3
  * @see app.swisseph.core.SweConst#SE_HOUSE4
  * @see app.swisseph.core.SweConst#SE_HOUSE5
  * @see app.swisseph.core.SweConst#SE_HOUSE6
  * @see app.swisseph.core.SweConst#SE_HOUSE7
  * @see app.swisseph.core.SweConst#SE_HOUSE8
  * @see app.swisseph.core.SweConst#SE_HOUSE9
  * @see app.swisseph.core.SweConst#SE_HOUSE10
  * @see app.swisseph.core.SweConst#SE_HOUSE11
  * @see app.swisseph.core.SweConst#SE_HOUSE12
  * @see app.swisseph.core.SweConst#SE_ASC
  * @see app.swisseph.core.SweConst#SE_MC
  * @see app.swisseph.core.SweConst#SE_ARMC
  * @see app.swisseph.core.SweConst#SE_VERTEX
  * @see app.swisseph.core.SweConst#SE_EQUASC
  * @see app.swisseph.core.SweConst#SE_COASC1
  * @see app.swisseph.core.SweConst#SE_COASC2
  * @see app.swisseph.core.SweConst#SE_POLASC
  * @see app.swisseph.core.SweConst#SE_HSYS_PLACIDUS
  * @see app.swisseph.core.SweConst#SE_HSYS_KOCH
  * @see app.swisseph.core.SweConst#SE_HSYS_PORPHYRIUS
  * @see app.swisseph.core.SweConst#SE_HSYS_REGIOMONTANUS
  * @see app.swisseph.core.SweConst#SE_HSYS_CAMPANUS
  * @see app.swisseph.core.SweConst#SE_HSYS_EQUAL
  * @see app.swisseph.core.SweConst#SE_HSYS_VEHLOW
  * @see app.swisseph.core.SweConst#SE_HSYS_MERIDIAN
  * @see app.swisseph.core.SweConst#SE_HSYS_HORIZONTAL
  * @see app.swisseph.core.SweConst#SE_HSYS_POLICH_PAGE
  * @see app.swisseph.core.SweConst#SE_HSYS_ALCABITIUS
//  * @see app.swisseph.core.SweConst#SE_HSYS_GAUQUELIN_SECTORS
  * @see app.swisseph.core.SweConst#SE_HSYS_MORINUS
  * @see app.swisseph.core.SweConst#SE_HSYS_KRUSINSKI
  * @see app.swisseph.core.SweConst#SE_HSYS_WHOLE_SIGN
  */
