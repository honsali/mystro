...
// endif /* SE_EPHE_PATH */
     ...
     *
     * @see app.swisseph.core.SwissEph#swe_rise_trans(double, int, java.lang.StringBuilder, int, int, double[], double, double, app.swisseph.core.DblObj, java.lang.StringBuilder)
     */
     ...
     *
     * @see app.swisseph.core.SwissEph#swe_azalt(double, int, double[], double, double, double[], double[])
     */
    int SE_ECL2HOR = 0;
    /**
     * This is a constant to be used as a flag to swe_azalt(). It determines the
     ...
     * long., xout[1]=&nbsp;ecl. lat..
     *
     * @see app.swisseph.core.SwissEph#swe_azalt_rev(double, int, double[], double[], double[])
     */
    int SE_HOR2ECL = 0;
    /**
     * This is a constant to be used as a flag to swe_azalt_rev(). It determines
     ...
     *
     * @see app.swisseph.core.SwissEph#swe_refrac(double, double, double, int)
     * @see #SE_APP_TO_TRUE
     */
