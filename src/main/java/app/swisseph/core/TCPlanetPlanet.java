...
public class TCPlanetPlanet extends TransitCalculator {
     ...
     *            in deg/day.
     * @see app.swisseph.core.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double, int, double)
     * @see app.swisseph.core.TCPlanet#TCPlanet(SwissEph, int, int, double)
     * @see app.swisseph.core.TCPlanet#TCPlanet(SwissEph, int, int, double, int, double)
     * @see app.swisseph.core.SweConst#SEFLG_TRANSIT_LONGITUDE
     * @see app.swisseph.core.SweConst#SEFLG_TRANSIT_LATITUDE
     * @see app.swisseph.core.SweConst#SEFLG_TRANSIT_DISTANCE
     * @see app.swisseph.core.SweConst#SEFLG_TRANSIT_SPEED
     * @see app.swisseph.core.SweConst#SE_AST_OFFSET
     * @see app.swisseph.core.SweConst#SEFLG_PARTILE_TRANSIT
     * @see app.swisseph.core.SweConst#SEFLG_PARTILE_TRANSIT_START
     * @see app.swisseph.core.SweConst#SEFLG_PARTILE_TRANSIT_END
     * @see app.swisseph.core.SweConst#SEFLG_YOGA_TRANSIT
     * @see app.swisseph.core.SweConst#SEFLG_TOPOCTR
     * @see app.swisseph.core.SweConst#SEFLG_EQUATORIAL
     * @see app.swisseph.core.SweConst#SEFLG_HELCTR
     * @see app.swisseph.core.SweConst#SEFLG_TRUEPOS
     * @see app.swisseph.core.SweConst#SEFLG_SIDEREAL
     * @see app.swisseph.core.SweConst#SEFLG_MOSEPH
     * @see app.swisseph.core.SweConst#SEFLG_SWIEPH
     * @see app.swisseph.core.SweConst#SEFLG_JPLEPH
     */
