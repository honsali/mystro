...
public final class JsonFileSupport {
    private static final SimpleModule DOUBLE_ROUNDING_MODULE = new SimpleModule()
            .addSerializer(Double.class, new TwoDecimalDoubleSerializer())
            .addSerializer(Double.TYPE, new TwoDecimalDoubleSerializer());

    private static final ObjectMapper MAPPER = new ObjectMapper()
            .registerModule(new JavaTimeModule())
            .registerModule(DOUBLE_ROUNDING_MODULE)
